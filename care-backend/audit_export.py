"""Audit comparison CSV — product scores vs manual QA columns (+ optional rules rescore)."""
...
from database import list_calls
...
def build_audit_comparison_csv_bytes(
    ...
    headers = list(AUDIT_HEADERS)
    if rescore:
        headers.extend(RESCORE_HEADERS)
